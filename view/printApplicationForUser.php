		...
		<form>
			...
			<table class="tableNoOne">
				<tr>
					...
					<td><center>Nick Li Consultancy OPC<br><br><b>Online Leave Management System</b></center></td> 
			...
			<table class="tableNoTwo">
				...
				<tr>
					<td style="text-decoration: underline;"><b>To the filled by the Applicant:</b></td>
					<td><span class="alignLeft">Date: <?php echo date("M/d/y"); ?></span></td>
				</tr>
			</table>
			<br>
			<table class="tableNoTwo">
				...
				<tr>
					<td class="tableNoThreeOne">
						<TABLE class="tableNofour">
							...
							<TR>
								<TD class="tdStyleNoUnder"> Birthday Leave</TD>
								<TD>
								<?php 
								if($row['lLeaveId'] == 3) 
								{ ?>
