			...
			<div id="wrapper">
				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						...
						<li>
							<a style="color:#DAA520;" href="ListOfUserBlood.php"><i class="fas fa-heartbeat"></i> Blood Group</a>
						</li>
						<li>
							...
							<div class="col-lg-12">
								...
								<form role="form" action="" method="" >
									...
									<div class="form-group">
										...
										<?php
										echo "<table class='table table-bordered table-hover table-striped' name='subcat'><thead><tr class='success'><th>Name</th><th>Department</th><th>Designation</th><th>Blood Group</th><th>Phone Number</th></tr></thead><tbody>";
